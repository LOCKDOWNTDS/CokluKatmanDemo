...
namespace CompanyInfo.Entities.Migrations
{
    ...
    [Migration("20240612125759_UsersAndRoles")]
            ...
            modelBuilder.Entity("CompanyInfo.Entities.Models.Concrete.Birim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            BirimAdi = "Adet",
                            CreateDate = new DateTime(2024, 6, 12, 15, 57, 58, 428, DateTimeKind.Local).AddTicks(2081)
                        },
                        new
                        {
                            Id = 2,
                            BirimAdi = "Cm",
                            CreateDate = new DateTime(2024, 6, 12, 15, 57, 58, 428, DateTimeKind.Local).AddTicks(2084)
                        },
                        new
                        {
                            Id = 3,
                            BirimAdi = "Gram",
                            CreateDate = new DateTime(2024, 6, 12, 15, 57, 58, 428, DateTimeKind.Local).AddTicks(2086)
                        },
                        new
                        {
                            Id = 4,
                            BirimAdi = "Miligram",
                            CreateDate = new DateTime(2024, 6, 12, 15, 57, 58, 428, DateTimeKind.Local).AddTicks(2088)
                        });
                });
            ...
            modelBuilder.Entity("CompanyInfo.Entities.Models.Concrete.Kategori", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2024, 6, 12, 15, 57, 58, 428, DateTimeKind.Local).AddTicks(5461),
                            KategoriAdi = "Gida"
                        },
                        new
                        {
                            Id = 2,
                            CreateDate = new DateTime(2024, 6, 12, 15, 57, 58, 428, DateTimeKind.Local).AddTicks(5463),
                            KategoriAdi = "Tekstil"
                        },
                        new
                        {
                            Id = 3,
                            CreateDate = new DateTime(2024, 6, 12, 15, 57, 58, 428, DateTimeKind.Local).AddTicks(5466),
                            KategoriAdi = "Eletronik"
                        },
                        new
                        {
                            Id = 4,
                            CreateDate = new DateTime(2024, 6, 12, 15, 57, 58, 428, DateTimeKind.Local).AddTicks(5468),
            ...
            modelBuilder.Entity("CompanyInfo.Entities.Models.Concrete.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2024, 6, 12, 15, 57, 58, 428, DateTimeKind.Local).AddTicks(8547),
                            RoleAdi = "Admin"
                        },
                        new
                        {
                            Id = 2,
                            CreateDate = new DateTime(2024, 6, 12, 15, 57, 58, 428, DateTimeKind.Local).AddTicks(8553),
                            RoleAdi = "User"
                        },
                        new
                        {
                            Id = 3,
                            CreateDate = new DateTime(2024, 6, 12, 15, 57, 58, 428, DateTimeKind.Local).AddTicks(8554),
                            RoleAdi = "Satis"
                        });
                });
            ...
            modelBuilder.Entity("CompanyInfo.Entities.Models.Concrete.Tedarikci", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2024, 6, 12, 15, 57, 58, 429, DateTimeKind.Local).AddTicks(1491),
                            SirketAdi = "Abc",
                            VergiNo = "123"
                        },
                        new
                        {
                            Id = 2,
                            CreateDate = new DateTime(2024, 6, 12, 15, 57, 58, 429, DateTimeKind.Local).AddTicks(1494),
                            SirketAdi = "Asd",
                            VergiNo = "456"
                        },
                        new
                        {
                            Id = 3,
                            CreateDate = new DateTime(2024, 6, 12, 15, 57, 58, 429, DateTimeKind.Local).AddTicks(1496),
                            SirketAdi = "Qwe",
                            VergiNo = "7789"
                        });
                });
